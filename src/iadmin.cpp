...
usage( char *subOpt ) {
    ...
    char* set_grid_configuration_usage[] = {
        ...
        " ",
        "Set the specified OPTION_NAME to OPTION_VALUE for the specified NAMESPACE in the local zone in",
        "R_GRID_CONFIGURATION. If NAMESPACE or OPTION_NAME is not valid, an error is returned.",
        ""};

    char* get_grid_configuration_usage[] = {
        "get_grid_configuration NAMESPACE OPTION_NAME",
        " ",
        "Prints local zone grid configuration value for specified namespace and option name.",
        " ",
        "This command allows administrators to view grid configuration values without running queries directly",
        "against the database. If NAMESPACE or OPTION_NAME is not valid, an error is returned.",
        " ",
