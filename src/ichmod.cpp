...
void
usage() {
    char* msgs[] = {"Usage: ichmod [-rhvVM] ACCESS_LEVEL USER_OR_GROUP LOGICAL_PATH ...",
                    ...
                    " ",
                    "Setting the ACCESS_LEVEL to 'null' will remove access for that "
                    "USER_OR_GROUP.",
                    " ",
                    ...
                    " ",
                    "The -M option allows a rodsadmin to set an ACCESS_LEVEL without having "
                    "'own'.",
                    " ",
                    ...
                    " - imv - requires 'delete_object' or greater, due to removal of old "
                    "name",
